#Create the LSH hash by converting each element in the projected matrix to either 0 or 1.
...
###  vectorize the tx01 function
data01 = vtx01(data25)
### apply function to each element in data25
